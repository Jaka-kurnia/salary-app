...
const Page = () => {
  ...
  const leaveHistory = [
    ...
    { jenis: "Tahunan", tanggal: "01 Apr - 03 Apr 2024", durasi: "3 Hari", alasan: "Mudik Lebaran", status: "PENDING" },
  ];

  return (
    /* KUNCI SIDEBAR TETAP:
       1. h-screen: Membatasi tinggi elemen seukuran layar monitor.
       2. overflow-hidden: Mematikan scroll pada level paling luar.
    */
    <div className="flex h-screen overflow-hidden bg-[#F4F7FE]">
      
      {/* Sidebar akan tetap di posisinya karena berada di luar container scroll */}
      <SidebarUser />
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* KUNCI CONTENT SCROLL:
           1. flex-1: Mengambil sisa ruang tinggi yang ada.
           2. overflow-y-auto: Mengaktifkan scroll hanya di dalam area main ini.
        */}
                    ...
                    {leaveHistory.map((row, i) => (
                      <tr key={i} className="hover:bg-slate-50/30 transition-colors">
                        ...
                        <td className="px-8 py-6 text-right">
                          <span className={`px-4 py-1.5 rounded-lg text-[10px] font-black tracking-widest ${
